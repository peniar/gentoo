...
QA_PREBUILT="usr/share/elasticsearch/modules/x-pack-ml/platform/linux-${ARCH_ALT}/\(bin\|lib\)/.*"
QA_PRESTRIPPED="usr/share/elasticsearch/modules/x-pack-ml/platform/linux-${ARCH_ALT}/\(bin\|lib\)/.*"
...
src_install() {
	...
	fperms -R +x /usr/share/${PN}/modules/x-pack-ml/platform/linux-${ARCH_ALT}/bin
